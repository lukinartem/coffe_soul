...
<body>
    ...
    <main class="main">
        <div class="order_wrapper">
            <div class="title_btn">
                <a href="index2.php" class="order_btn button">Вернуться к заказу</a>
                <h2 class="order_title title">Регистрация</h2>
            </div>
            <form action ="php/register.php" method="post">
                <input type="email" class="form_control" name="email" id="email" placeholder="Введите почту"> 
              
                <input type="text" class="form_control" name="name" id="name" placeholder="Введите имя"> 

                <input type="adress" class="form_control" name="adress" id="adress" placeholder="Введите адрес доставки">

                <input type="phone" class="form_control" name="phone" id="phone" data-phone-pattern placeholder="Введите телефон" />
               
                <input type="password" class="form_control" name="password" id="password" placeholder="Введите пароль"> 
                
                <button type="submit" class="form_btn btn" name="button-reg">Зарегистрировать</button>
