        ...
        <div class="container">
            <div class="header__nav">
                ...
                <nav class="nav">
                    <ul class="nav-list">
                        <li class="nav-item">
                            <a href="./index2.html" href="#section_main" class="nav-link">Главная</a></li>
                        <li class="nav-item">
    ...
    <main class="main">
        <div class="order_wrapper">
            <div class="title_btn">
                ...
                <h2 class="order_title title">Авторизация</h2>
            </div>
            <form action="php/login.php" method="post">
                <input type="email" class="form_control" name="email" id="email" placeholder="Введите email"> 
            ...
            <a href="registerhtml.php" class="form_btn btn">Зарегистрироваться</a>
        </div>
    </main> 
